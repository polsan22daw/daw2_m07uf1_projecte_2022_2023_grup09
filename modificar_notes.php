...
<body>
    <form action="modificar_notes.php" method="post">
        <label for="nom">Id del alumne:</label>
        <input type="number" name="id" id="id" required><br>
        <select>
            <option value="nota1" name="nota1">M01</option>
            <option value="nota2" name="nota2">M02</option>
            <option value="nota3" name="nota3">M03</option>
            <option value="nota4" name="nota4">M04</option>
            <option value="nota5" name="nota5">M011</option>
            <option value="nota6" name="nota6">M012</option>
        </select>
        <label for="cognom">Nota:</label>
        <input type="number" name="notaantiga" id="notaantiga" required><br>
        <label for="id">Nota nova:</label>
        <input type="number" name="notanova" id="notanova" required><br>
